       ...
       Begin.
           ...
           PERFORM WITH TEST AFTER UNTIL EndOfInput
             PERFORM WITH TEST AFTER UNTIL ValidCountryCode OR
                                           EndOfInput
               ...
               SEARCH ALL Country
                   AT END IF NOT EndOfInput
                             DISPLAY "Country code " CountryCodeIn
                                     " is not valid"
                          END-IF
                   WHEN CountryCode(Cidx) =
                                      FUNCTION UPPER-CASE(CountryCodeIn)
      ...
      * Loads table with HIGH-VALUES so the SEARCH ALL works when the
